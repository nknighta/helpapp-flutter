# AGENTS.md for Flutter machinaka app
...
## description
This is a Flutter application to assist people with disabilities.
It uses the Mapbox SDK and an API server built with Firebase and Vercel.

## Repository overview
- **Source code**: `lib/` contains the main application code organized by features.
- **Pages**: `lib/displays` for UI screens and navigation.
- **Services**: `lib/services` for backend communication and business logic.
- **Utils** : `lib/utils/` for helper functions and constants.
...
- **Using API**: Mapbox API for maps and location services. Firebase for authentication, database
- **Docs for Agents**: `/agent-docs` folder with specific guidelines for AI agents.
